...
- `0.1.0` — the first published early-development release.
...
Pre-release builds use identifiers such as `0.2.0-alpha.1`, `0.2.0-beta.1`, or
...
2. A matching annotated Git tag such as `v0.1.0`.
